...
const selectedPokemon = [
  pokemon.find((poke) => poke.name === "Pikachu"),
  pokemon.find((poke) => poke.name === "Jigglypuff"),
  pokemon.find((poke) => poke.name === "Abra"),
]
...
const bulbasaurIndex = game.party.findIndex(
  (pokemon) => pokemon.name === "Bulbasaur"
)
if (bulbasaurIndex !== -1) {
  game.party.splice(bulbasaurIndex, 1, evolvedPokemon)
}
...
*/
// ( note i find some difficulty in creating a method)
/*
Exercise 11
